...
public class KMeansMapper extends
		Mapper<LongWritable,Text, CenterCentroidWritable, Vector> {

	List<ClusterCenter> centers = new LinkedList<ClusterCenter>();
	List<ClusterCenter> canopys = new LinkedList<ClusterCenter>();
	...
	protected void setup(Context context) throws IOException,
		...
		Path canopyCenters = new Path("/home/training/Desktop/Kmeans/canopyCenters.seq");
		
		//Reading canopy.
		@SuppressWarnings("deprecation")
		SequenceFile.Reader canopyReader = new SequenceFile.Reader(fs, canopyCenters,
				conf);
		...
		SequenceFile.Reader canopyWithKReader = new SequenceFile.Reader(fs, canopyWithK,
				conf);
