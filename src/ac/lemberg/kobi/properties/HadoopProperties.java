...
public class HadoopProperties implements Serializable{
	...
	public String toString() {
		return "HadoopProperties [jobServerInputFolderPath="
				+ jobServerInputFolderPath + ", jobServerOutputFolderPath="
				+ jobServerOutputFolderPath + ", numOfFeatures="
				+ numOfFeatures + ", numOfDays=" + numOfDays + ", numOfStocks="
				+ numOfStocks + ", StockCSVFileName=" + StockCSVFileName
				+ ", StockCSVFilePath=" + StockCSVFilePath + ", numOfClusters="
				+ numOfClusters + ", high=" + high + ", close=" + close
				+ ", low=" + low + ", open=" + open + "]";
	}
