...
public class CanopyClusteringJob {
  ...
  public static void main(String[] args) throws Exception {
     ...
     */
    job.setJarByClass(CanopyClusteringJob.class);
    ...
    //SequenceFileOutputFormat.setOutputPath(job, new Path("/home/training/Desktop/Canopy/output"));
    job.setMapOutputKeyClass(IntWritable.class);
    job.setMapOutputValueClass(ClusterCenter.class);
    //job.setOutputFormatClass(SequenceFileOutputFormat.class);
    //SequenceFileOutputFormat.setOutputPath(job, new
    //Path("hdfs://127.0.0.1:50070/sequenceOutput"));
